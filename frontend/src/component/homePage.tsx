...
function Home() {
  ...
  return (
    <div>
      ...
      <div className="relative z-10 px-5 flex flex-col items-center gap-4 mx-2 md:mx-56 mt-32 rounded-xl pb-8 bg-gradient-to-b from-neutral-900 to-neutral-800">
      ...
      <div className='items-center gap-4 mt-20 mx-2 md:mx-56 '>
        ...
        <div className='md:flex justify-between w-full my-10 mt-7'>
          <UseCase
      ...
      <div className='mt-20 mx-2 md:mx-56  '>
