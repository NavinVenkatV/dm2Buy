...
function Home() {
  ...
  return (
    <div>
      ...
      <div className="relative z-10 px-5 flex flex-col items-center gap-4 mx-2 lg:mx-56 mt-32 rounded-xl pb-8 bg-gradient-to-b from-neutral-900 to-neutral-800">
        ...
        <div className="max-w-4xl text-center text-3xl md:text-6xl">
          Store & collaborate on code snippets✨in real time
        </div>
        <div className='text-neutral-400 text-center'>Create. Share. Collaborate. Code, simplified.</div>
        <button
        onClick={() => {
            navigate('/snippet')
        }} 
      ...
      <div className='items-center gap-4 mt-20 mx-2 lg:mx-56 '>
        ...
        <div className='lg:flex justify-between w-full my-10 mt-7'>
          <UseCase
        ...
        <div className='lg:flex justify-between w-full'>
          ...
          />
          {/* <div className='text-5xl items-center  max-w-sm text-neutral-600 flex justify-center mt-2 md:mt-0'>Real Time Coding</div> */}
        </div>
      </div>

      <div className='mt-20 mx-2 lg:mx-56  '>
        <div className='text-3xl md:text-5xl text-center my-10 text-neutral-600'>Collaborate and learn</div>
        <img src="image.png" alt="code" className='rounded-xl object-cover' />
      </div>
